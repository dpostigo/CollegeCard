...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	// Username and userPassword used for authentication
	NSString *username;
	NSString *password;
	...
	// Username and userPassword used for proxy authentication
...
// Should be an HTTP or HTTPS url, may include username and userPassword if appropriate
...
// Attempt to obtain credentials for this request from the URL, username and userPassword or keychain
...
// Construct a basic authentication header from the username and userPassword supplied, and add it to the request headers
